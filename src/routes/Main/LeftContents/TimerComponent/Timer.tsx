...
export default function Timer({
  ...
  return (
    <>
      <article
        className={`LAB-digital flex flex-col gap-[10px] items-center justify-center w-[25rem] h-[25rem] bg-[#F0F5F8] transition-colors duration-200 mix-blend-multiply ${
          polygonForm === "circle" ? "rounded-full" : "rounded-t-[30px]"
        }`}
        style={style}
      >
        {isStaticTime ? (
